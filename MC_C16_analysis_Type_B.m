...
%    All_data = dlmread(['MC_C16_Type_B_' int2str(run) '.txt']); % For the Monte Carlo sampling sets with Type B
   
   All_data = dlmread(['MC_C16_Type_CH2_opt_' int2str(run) '.txt']); % For the Monte Carlo sampling sets with Type B only for CH3, CH2 is at the optimal
