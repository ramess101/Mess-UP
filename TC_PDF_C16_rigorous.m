...
% TC_range = linspace(725,732,70); % For the Type A analysis
TC_range = linspace(719,738,190); % For the Type AB analysis

PDF_TC = zeros(length(sigma),length(TC_range));

for m = 79:length(sigma)
...
A_range = linspace(0.96,1.04,50)*A_fit;
b_range = linspace(0.995,1.005,50)*b_fit;
pc_range = linspace(0.985,1.015,40)*pc_fit;
