...
TC_range = linspace(875,925,50);

PDF_TC = zeros(length(sigma),length(TC_range));

for m = 47:length(sigma)
...
A_range = linspace(0.75,1.25,40)*A_fit;
b_range = linspace(0.96,1.04,40)*b_fit;
pc_range = linspace(0.85,1.15,40)*pc_fit;
